(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
            ...
            app.post("/admin/menus", null, function (data) {
                            ...
                            $.each(childNodes, function (i) {
                                ...
                                if (subchildNodes.length > 0) {
                                    ...
                                    $.each(subchildNodes, function (i) {
                                        ...
                                        _html += '<li><a class="menuItem" data-id="' + subchildNodesrow.id + '" href="' + subchildNodesrow.href + '"><i class="' + subchildNodesrow.icon + '"></i>' + subchildNodesrow.name + '</a></li>';

                                    });
                                    _html += '</ul>';

                                } else {
                                    _html += '<a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.href + '"><i class="' + subrow.icon + '"></i>' + subrow.name + '</a>';
