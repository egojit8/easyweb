...
import com.egojit.easyweb.common.utils.DateUtils;
import com.egojit.easyweb.common.utils.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	private static ApplicationContext context= SpringContextHolder.getApplicationContext();
