...
Source Database       : jeesite_admin

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2017-11-24 15:23:59
*/
...
CREATE TABLE `app_log` (
  ...
  `platform` varchar(40) DEFAULT NULL COMMENT '平台:ios,android',
  `category` varchar(80) DEFAULT NULL COMMENT '小类别',
  `content` text COMMENT '内容',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` varchar(40) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='移动日志';

-- ----------------------------
-- Records of app_log
-- ----------------------------
INSERT INTO `app_log` VALUES ('7ba737a9ae594a4a8dd72fb94dd0af3d', null, null, null, '2017-09-28 15:36:51', '1');
...
-- ----------------------------
INSERT INTO `gen_scheme` VALUES ('9ddfa84b9593428dab957b138557fdcc', 'app_log表单', 'curd', 'com.thinkgem.jeesite.modules', 'app', '', '移动日志记录', '移动管理', 'egojit', 'b0322cd5c02b4af982217475127e103e', '1', '2017-09-28 12:52:48', '1', '2017-09-28 12:53:04', '', '0');
...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('b0322cd5c02b4af982217475127e103e', 'app_log', '移动日志', 'AppLog', '', '', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', '', '0');
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES ('4f38ca293144431b91e3bf4c65eec59c', 'b0322cd5c02b4af982217475127e103e', 'platform', '平台:ios,android', 'varchar(40)', 'String', 'platform', null, '1', '1', '1', null, null, '=', 'input', '', null, '20', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
INSERT INTO `gen_table_column` VALUES ('5ce9cc8608bf47a5a012069007a4c487', 'b0322cd5c02b4af982217475127e103e', 'content', '内容', 'text', 'String', 'content', null, '1', '1', '1', null, null, '=', 'textarea', '', null, '40', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
INSERT INTO `gen_table_column` VALUES ('c28ab25858fb4f15ad79391f1bf15eb6', 'b0322cd5c02b4af982217475127e103e', 'id', 'id', 'varchar(64)', 'String', 'id', '1', null, '1', null, null, null, '=', 'input', '', null, '10', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
INSERT INTO `gen_table_column` VALUES ('c2a2a7cb2f054e6d8f3606e97e598db2', 'b0322cd5c02b4af982217475127e103e', 'category', '小类别', 'varchar(80)', 'String', 'category', null, '1', '1', '1', null, null, '=', 'input', '', null, '30', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
INSERT INTO `gen_table_column` VALUES ('e087682109f84d7d83350072fb7bfc44', 'b0322cd5c02b4af982217475127e103e', 'create_by', '创建人', 'varchar(40)', 'com.thinkgem.jeesite.modules.sys.entity.User', 'createBy.id', null, '1', '1', null, null, null, '=', 'input', '', null, '60', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
INSERT INTO `gen_table_column` VALUES ('f7aaf6882d2b4aada65ef22deec0fc0a', 'b0322cd5c02b4af982217475127e103e', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', null, '1', '1', null, null, null, '=', 'dateselect', '', null, '50', '1', '2017-09-28 12:46:55', '1', '2017-09-28 12:46:55', null, '0');
...
-- ----------------------------
-- Table structure for `im_push`
-- ----------------------------
DROP TABLE IF EXISTS `im_push`;
CREATE TABLE `im_push` (
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` varchar(800) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容',
  `tag` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标签',
  `to_obj` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接收人',
...
-- ----------------------------
-- Table structure for `im_push_queue`
-- ----------------------------
DROP TABLE IF EXISTS `im_push_queue`;
CREATE TABLE `im_push_queue` (
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` varchar(800) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容',
  `toObj` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发送对象',
  `create_date` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of im_push_queue
-- ----------------------------
...
INSERT INTO `sys_menu` VALUES ('3', '2', '0,1,2,', '字典管理', '8', '/sys/dict/', null, 'list', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('35f1947b4df9429bb9ee7dc0239d0a0b', '2', '0,1,2,', '日志管理', '5', '/app/appLog/list', '', '', '1', '', '1', '2017-09-28 15:42:53', '1', '2017-09-28 15:42:53', '', '0');
INSERT INTO `sys_menu` VALUES ('4', '2', '0,1,2,', '区域管理', '7', '/sys/area/', null, 'th', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('5', '2', '0,1,2,', '机构管理', '3', '/sys/office/', null, 'th-large', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('6', '2', '0,1,2,', '用户管理', '1', '/admin/user/index', null, 'user', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('7', '2', '0,1,2,', '菜单管理', '4', '/admin/menu/', null, 'list-alt', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('8', '2', '0,1,2,', '角色管理', '2', '/sys/role/', null, 'lock', '1', null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
INSERT INTO `sys_menu` VALUES ('9', '2', '0,1,2,', '连接池监视', '9', '/druid', null, null, '1', null, '1', '2013-10-18 08:00:00', '1', '2013-10-18 08:00:00', null, '0');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '2', '系统管理员', 'dept', 'assignment', '1', '1', '1', '1', '2013-05-27 08:00:00', '1', '2017-09-28 15:49:19', '', '0');
...
INSERT INTO `sys_role_menu` VALUES ('1', '35f1947b4df9429bb9ee7dc0239d0a0b');
...
INSERT INTO `sys_role_menu` VALUES ('1', 'c8b204ceb5ed44259a6ac1db5db5ea56');
...
CREATE TABLE `sys_user` (
  ...
  `user_type` char(1) DEFAULT NULL COMMENT '用户类型，0普通用户，1管理员用户',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '2', 'admin', 'df655ad8d3229f3269fad2a8bab59b6c', '0001', '系统管理员', 'egojit@qq.com', '8675', '8675', null, '/jeesite/userfiles/1/images/photo/2017/09/000220drnpczc0trrnnpnl.gif', '0:0:0:0:0:0:0:1', '2017-09-28 15:39:53', '1', '1', '2013-05-27 08:00:00', '1', '2017-09-12 17:09:51', '最高管理员', '0');
